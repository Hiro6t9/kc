...
const Footer = () => {
  ...
  return (
    <footer className="w-full py-8 px-4 mt-12 text-center">
      <div className="max-w-7xl mx-auto relative overflow-hidden glass-card p-6 animate-on-scroll opacity-0 transition-all duration-500">
        {/* Animated background effect */}
        <div className="absolute inset-0 bg-gradient-to-r from-krinix-accent/10 to-transparent w-[200%] animate-slide-gradient"></div>
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 transition-all duration-300 hover:text-krinix-accent">
